[![React App CI](https://github.com/chandran-karuppiah16/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/chandran-karuppiah16/ci-cd-with-actions/actions/workflows/ci.yml)
